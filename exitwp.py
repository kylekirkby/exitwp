...
def parse_wp_xml(file):
    ...
    def parse_items():
        ...
        for i in xml_items:
            ...
            download_presentation_url = "None"
            ...
            meta_tags = i.findall(ns["wp"]+"postmeta")
            for each in meta_tags:
                key = each.findall(ns["wp"]+"meta_key")
                value = each.findall(ns["wp"]+"meta_value")
                print(key[0].text, value[0].text)
                
                if key[0].text:
                    if key[0].text == "_downloadpresentation":
                        download_presentation_url = value[0].text
                    elif key[0].text == "_downloadvideo":
                        download_video_url = value[0].text
                    elif key[0].text == "_sessionID":
                        session_id = value[0].text
                    elif key[0].text == "tm_video_url":
                        youtube_video_url = value[0].text
                    elif key[0].text == "_speakers":
                        speakers = value[0].text
                    elif key[0].text == "_presentation":
                        slideshare_presentation_url = value[0].text
                    elif key[0].text == "_track":
                        session_track = value[0].text
                    elif key[0].text == "time_video":
                        video_length = value[0].text
                    elif key[0].text == "video_thumbnail":
                        video_thumbnail = value[0].text
            ...
            export_item = {
                ...
                'slideshare_presentation_url' : slideshare_presentation_url,
                'amazon_s3_presentation_url' : download_presentation_url,
                'amazon_s3_video_url' : download_video_url,
...
def write_jekyll(data, target_format):
    ...
    for i in data['items']:
    	...
    	if i['youtube_video_url']:
                yaml_header['youtube_video_url'] = i['youtube_video_url']
    	if i['slideshare_presentation_url']:
                yaml_header['slideshare_presentation_url'] = i['slideshare_presentation_url']
    	if i['amazon_s3_video_url']:
                yaml_header['amazon_s3_video_url'] = i['amazon_s3_video_url']
    	if i['amazon_s3_presentation_url']:
                yaml_header['amazon_s3_presentation_url'] = i['amazon_s3_presentation_url']
    	if i['session_id']:
                yaml_header['session_id'] = i['session_id']
    	if i['speakers']:
                yaml_header['speakers'] = i['speakers']
    	if i['session_track']:
                yaml_header['session_track'] = i['session_track']
    	if i['video_length']:
                yaml_header['video_length'] = i['video_length']
    	if i['video_thumbnail']:
                yaml_header['video_thumbnail'] = i['video_thumbnail']
